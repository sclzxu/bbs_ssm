			...
			<div class="widget">
				<div class="formRow">
            		<label>版块<span class="req">*</span></label>
          			<div class="formRight">
          				<div class="floatL">
           					<select name="plate.plateId" class="validate[required]" >
            	...
            	<div class="formRow">
            		<label>分类<span class="req">*</span></label>
          			<div class="formRight">
          				<div class="floatL">
           					<select name="category.categoryId" class="validate[required]" >
                    		<option value="0">分类</option>
                    		<c:forEach items="${categories }" var="ctg">
                    			<option value="${ctg.categoryId }">${ctg.category }</option>
                    		</c:forEach>
                     		</select>
                 		</div>
         			</div>
