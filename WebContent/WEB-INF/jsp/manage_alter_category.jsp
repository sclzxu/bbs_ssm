...
<div id="rightSide">
    ...
    <div class="wrapper">
    	...
    	<!-- Validation form -->
    	<form:form cssClass="form" method="post" modelAttribute="category" 
    			action="${pageContext.request.contextPath}/server/manage_alter_category">
    		<form:hidden path="categoryId"/>
        	<fieldset>
                <div class="widget">
                    <div class="title"><img src="${pageContext.request.contextPath}/statics/image/icons/dark/alert.png" alt="" class="titleIcon" /><h6>分类修改</h6></div>
                    <div class="formRow">
                    	<form:label path="category">分类标题:<span class="req">*</span></form:label>
                        <div class="formRight">
                        	<form:input path="category" cssClass="validate[required]"/>
